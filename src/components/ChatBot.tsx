...
const services = [
  ...
  { value: "algorithmic-infrastructure", label: "Algorithmic Infrastructure Optimization" },
  { value: "custom-algorithm", label: "Custom Algorithm Development" },
            ...
            <form onSubmit={handleFormSubmit} className="space-y-3">
              ...
              <div>
                ...
                >
                  ...
                  <SelectContent
                    className="z-[10000] bg-popover border border-border"
                    position="popper"
                    sideOffset={6}
                    collisionPadding={12}
                  >
