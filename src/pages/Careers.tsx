...
import heroBg from "@/assets/hero-bg-careers.webp";
...
const Careers = () => {
  return (
    <>
      <Helmet>
        <title>Careers at TechPivot | Software, AI & Cloud Jobs</title>
        <meta name="description" content="Explore careers at TechPivot. Apply for jobs in software engineering, AI and machine learning, cloud, DevOps, QA and design. Grow with a global tech team." />
        <meta name="keywords" content="software jobs, AI engineer jobs, careers in technology, hiring developers, cloud engineer jobs, IT careers India, TechPivot careers, apply for software jobs" />
        <link rel="canonical" href="https://techpivot.in/careers" />
        <meta property="og:title" content="Careers at TechPivot | Software, AI & Cloud Jobs" />
        <meta property="og:description" content="Explore careers at TechPivot. Apply for jobs in software engineering, AI and machine learning, cloud, DevOps, QA and design. Grow with a global tech team." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://techpivot.in/careers" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Careers at TechPivot | Software, AI & Cloud Jobs" />
        <meta name="twitter:description" content="Explore careers at TechPivot. Apply for jobs in software engineering, AI and machine learning, cloud, DevOps, QA and design. Grow with a global tech team." />
            ...
            <div className="container px-6 lg:px-12 relative z-10">
              <div className="max-w-3xl">
                ...
                <motion.h1 
                  ...
                  className="text-4xl md:text-5xl lg:text-6xl font-bold text-surface-dark-foreground tracking-tight mb-6"
                >
                ...
                <motion.p 
                  ...
                  className="text-xl text-surface-dark-foreground/70 mb-8"
                >
            ...
            <div className="container px-6 lg:px-12">
              ...
              <div className="max-w-4xl mx-auto space-y-4">
                {openPositions.map((position, index) => (
                  <AnimatedSection key={position.slug} animation="fadeUp" delay={index * 100}>
                    <motion.div
