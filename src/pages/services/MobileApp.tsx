...
const MobileApp = () => {
  return (
    <ServicePageLayout
      ...
      metaTitle="Mobile App Development Company | iOS, Android & Flutter | TechPivot"
      metaDescription="Mobile app development services for iOS, Android, React Native and Flutter. Secure, scalable enterprise apps from design to App Store launch. Get a quote."
      keywords="mobile app development company, iOS app development, Android app development, React Native development, Flutter app development, cross platform app development, enterprise mobile apps, custom mobile application development"
