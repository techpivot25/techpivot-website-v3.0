...
const IoT = () => {
  return (
    <ServicePageLayout
      ...
      metaTitle="IoT Development Services | Smart Devices & Edge Computing | TechPivot"
      metaDescription="End-to-end IoT development: device connectivity, edge computing, telemetry dashboards and predictive maintenance for industry, healthcare and smart cities."
      keywords="IoT development services, IoT solutions company, industrial IoT, edge computing solutions, smart device development, IoT platform development, predictive maintenance IoT, IoT app development, connected devices"
