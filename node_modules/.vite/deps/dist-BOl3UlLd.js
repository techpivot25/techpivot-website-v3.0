	...
	parseRule(addedNodes) {
		...
		if (!this.contentDOM) rule.getContent = () => this.node.content;
			...
			if (!rule.contentElement) {
				...
				else rule.getContent = () => Fragment$1.empty;
			}
		}
		return rule;
	}
...
//#endregion
export { generateText as $, isProseMirrorRemoveMarkStep as $t, createChainableState as A, rewriteUnknownContent as An, isAndroid as At, elementFromString as B, keydownHandler as Bn, isNodeActive as Bt, attrsEqual as C, parseIndentedBlocks as Cn, getTextContentFromNodes as Ct, commands_exports as D, renderNestedMarkdownContent as Dn, injectExtensionAttributesToParseRule as Dt, combineTransactionSteps as E, removeDuplicates as En, h as Et, createStyleTag as F, textInputRule as Fn, isFirefox as Ft, findChildrenInRange as G, PluginKey as Gn, isPlainObject as Gt, escapeForRegEx as H, DecorationSet as Hn, isNodeSelection as Ht, createWidgetDecoration as I, textPasteRule as In, isFunction as It, findParentNodeClosestToPos as J, Mapping as Jn, isProseMirrorAttrStep as Jt, findDuplicates as K, Selection as Kn, isProseMirrorAddMarkStep as Kt, decodeHtmlEntities as L, textblockTypeInputRule as Ln, isList as Lt, createInlineMarkdownSpec as M, serializeAttributes as Mn, isAtStartOfNode as Mt, createMappablePosition as N, sortExtensions as Nn, isEmptyObject as Nt, createAtomBlockMarkdownSpec as O, resolveExtensions as On, inputRulesPlugin as Ot, createNodeFromContent as P, splitExtensions as Pn, isExtensionRulesEnabled as Pt, generateJSON as Q, isProseMirrorNodeSelection as Qt, defaultBlockAt as R, updateMarkViewAttributes as Rn, isMacOS as Rt, WidgetDecoration as S, parseAttributes as Sn, getTextBetween as St, canInsertNode as T, posToDOMRect as Tn, getUpdatedPosition as Tt, extensions_exports as U, NodeSelection as Un, isNodeViewSelected as Ut, encodeHtmlEntities as V, Decoration$1 as Vn, isNodeEmpty as Vt, findChildren as W, Plugin as Wn, isNumber as Wt, fromString as X, Fragment$1 as Xn, isProseMirrorDocAttrStep as Xt, flattenExtensions as Y, dropPoint as Yn, isProseMirrorCellSelection as Yt, generateHTML as Z, Slice as Zn, isProseMirrorFragment as Zt, NodeView as _, mergeDeep as _n, getSchemaTypeByName as _t, Editor as a, isProseMirrorStepResult as an, getHTMLFromFragment as at, ResizableNodeview as b, nodePasteRule as bn, getStyleProperty as bt, Fragment as c, isString as cn, getMarkType as ct, MappablePosition as d, liveWidgetKeys as dn, getNodeAttributes as dt, isProseMirrorRemoveNodeMarkStep as en, getAttributes as et, Mark as f, markInputRule as fn, getNodeType as ft, NodePos as g, mergeAttributes as gn, getSchemaByResolvedExtensions as gt, NodeDecoration as h, marksEqual as hn, getSchema as ht, DecorationManager as i, isProseMirrorStep as in, getExtensionField as it, createDocument as j, selectionToInsertionEnd as jn, isAtEndOfNode as jt, createBlockMarkdownSpec as k, resolveFocusPosition as kn, isActive as kt, InlineDecoration as l, isTextSelection as ln, getMarksBetween as lt, Node as m, markdown_exports as mn, getRenderedAttributes as mt, DECORATION_MANAGER_PLUGIN_KEY as n, isProseMirrorReplaceStep as nn, getChangedRanges as nt, Extendable as o, isRegExp as on, getMarkAttributes as ot, MarkView as p, markPasteRule as pn, getPreviousBlockSibling as pt, findParentNode as q, TextSelection as qn, isProseMirrorAddNodeMarkStep as qt, Decoration as r, isProseMirrorSlice as rn, getDebugJSON as rt, Extension as s, isSafari as sn, getMarkRange as st, CommandManager as t, isProseMirrorReplaceAroundStep as tn, getAttributesFromExtensions as tt, InputRule as u, isiOS as un, getNodeAtPosition as ut, PasteRule as v, minMax as vn, getSchemaTypeNameByName as vt, callOrReturn as w, pasteRulesPlugin as wn, getTextSerializersFromSchema as wt, Tracker as x, objectIncludes as xn, getText as xt, ResizableNodeView as y, nodeInputRule as yn, getSplittedAttributes as yt, deleteProps as z, wrappingInputRule as zn, isMarkActive as zt };
