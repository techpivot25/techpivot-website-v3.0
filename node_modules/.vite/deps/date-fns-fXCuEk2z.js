...
function intlFormatDistance(date, baseDate, options) {
	...
	if (!options?.unit) {
		...
		if (Math.abs(diffInSeconds) < 60) {
			...
			unit = "month";
		} else if (Math.abs(diffInSeconds) < 31556952) {
...
function parse(dateStr, formatStr, referenceDate, options) {
	...
	const weekStartsOn = options?.weekStartsOn ?? options?.locale?.options?.weekStartsOn ?? defaultOptions.weekStartsOn ?? defaultOptions.locale?.options?.weekStartsOn ?? 0;
	if (formatStr === "") {
		if (dateStr === "") return toDate(referenceDate);
...
function setDefaultOptions(options) {
	...
	for (const property in options) if (Object.prototype.hasOwnProperty.call(options, property)) {
		if (options[property] === void 0) delete result[property];
...
//#endregion
export { nextMonday as $, startOfWeekYear as $n, isDate as $r, setWeek as $t, setMonth as A, add as Ai, getDecade as An, differenceInYears as Ar, isThisMonth as At, previousThursday as B, formatISODuration as Bn, subISOWeekYears as Br, isSameISOWeekYear as Bt, setMinutes as C, startOfWeek as Ci, getMonth as Cn, eachQuarterOfInterval as Cr, isTomorrow as Ct, setDayOfYear as D, isWeekend as Di, getISODay as Dn, startOfMinute as Dr, isThisWeek as Dt, setDefaultOptions as E, addBusinessDays as Ei, getISOWeeksInYear as En, eachMinuteOfInterval as Er, isThisYear as Et, roundToNearestHours as F, getDate as Fn, isLastDayOfMonth as Fr, isSameSecond as Ft, previousDay as G, formatDistanceToNow as Gn, differenceInCalendarWeeks as Gr, isPast as Gt, previousSaturday as H, formatISO as Hn, differenceInMilliseconds as Hr, isSameWeek as Ht, quartersToYears as I, fromUnixTime as In, endOfMonth as Ir, startOfSecond as It, nextWednesday as J, format as Jn, differenceInCalendarMonths as Jr, parse as Jt, parseJSON as K, formatDistanceStrict as Kn, differenceInCalendarQuarters as Kr, isMonday as Kt, quartersToMonths as L, formatRelative as Ln, endOfDay as Lr, isSameQuarter as Lt, secondsToMilliseconds as M, addDays as Mi, isLeapYear as Mn, differenceInSeconds as Mr, isThisISOWeek as Mt, secondsToHours as N, constructFrom as Ni, getDaysInMonth as Nn, differenceInQuarters as Nr, isThisHour as Nt, setDate as O, isSunday as Oi, getHours as On, eachHourOfInterval as Or, isThisSecond as Ot, roundToNearestMinutes as P, toDate as Pi, getDay as Pn, differenceInMonths as Pr, isSameYear as Pt, nextSaturday as Q, getWeek as Qn, isValid as Qr, setISOWeek as Qt, previousWednesday as R, formatRFC7231 as Rn, differenceInMinutes as Rr, isSameMonth as Rt, setQuarter as S, startOfISOWeek as Si, getOverlappingDaysInIntervals as Sn, eachWeekOfInterval as Sr, isTuesday as St, setHours as T, addMilliseconds as Ti, getMilliseconds as Tn, eachMonthOfInterval as Tr, isThursday as Tt, previousMonday as U, formatDuration as Un, differenceInDays as Ur, isSameHour as Ut, previousSunday as V, formatISO9075 as Vn, differenceInHours as Vr, isSameISOWeek as Vt, previousFriday as W, formatDistanceToNowStrict as Wn, differenceInCalendarYears as Wr, startOfHour as Wt, nextThursday as X, formatters as Xn, differenceInCalendarISOWeekYears as Xr, setISODay as Xt, nextTuesday as Y, longFormatters as Yn, differenceInCalendarISOWeeks as Yr, parsers as Yt, nextSunday as Z, lightFormatters as Zn, differenceInBusinessDays as Zr, setDay as Zt, startOfToday as _, setISOWeekYear as _i, lastDayOfMonth as _n, startOfYear as _r, lastDayOfDecade as _t, subYears as a, closestTo as ai, isEqual as an, endOfTomorrow as ar, minutesToMilliseconds as at, setWeekYear as b, startOfDay as bi, getTime as bn, startOfMonth as br, isWithinInterval as bt, subQuarters as c, min as ci, intlFormatDistance as cn, endOfQuarter as cr, millisecondsToMinutes as ct, subHours as d, addYears as di, interval as dn, endOfISOWeek as dr, lightFormat as dt, isSameDay as ei, transpose as en, getWeekYear as er, nextFriday as et, subBusinessDays as f, addWeeks as fi, hoursToSeconds as fn, endOfWeek as fr, lastDayOfYear as ft, startOfTomorrow as g, addISOWeekYears as gi, getWeeksInMonth as gn, eachWeekendOfYear as gr, lastDayOfWeek as gt, startOfYesterday as h, addMinutes as hi, getYear as hn, eachYearOfInterval as hr, lastDayOfISOWeek as ht, weeksToDays as i, compareAsc as ii, isExists as in, endOfYesterday as ir, minutesToSeconds as it, secondsToMinutes as j, addMonths as ji, getDaysInYear as jn, differenceInWeeks as jr, isThisMinute as jt, set as k, isSaturday as ki, getDefaultOptions as kn, eachDayOfInterval as kr, isThisQuarter as kt, subMinutes as l, max as li, intlFormat as ln, endOfMinute as lr, millisecondsToHours as lt, subMonths as m, addQuarters as mi, hoursToMilliseconds as mn, endOfDecade as mr, lastDayOfISOWeekYear as mt, yearsToMonths as n, constructNow as ni, isFriday as nn, getDayOfYear as nr, monthsToYears as nt, subWeeks as o, closestIndexTo as oi, isBefore as on, endOfToday as or, minutesToHours as ot, sub as p, addSeconds as pi, hoursToMinutes as pn, endOfHour as pr, lastDayOfQuarter as pt, parseISO as q, formatDistance as qn, getQuarter as qr, isMatch as qt, yearsToDays as r, compareDesc as ri, isFirstDayOfMonth as rn, enUS as rr, monthsToQuarters as rt, subSeconds as s, clamp as si, isAfter as sn, endOfSecond as sr, millisecondsToSeconds as st, yearsToQuarters as t, daysToWeeks as ti, isFuture as tn, getISOWeek as tr, nextDay as tt, subMilliseconds as u, areIntervalsOverlapping as ui, intervalToDuration as un, endOfISOWeekYear as ur, milliseconds as ut, startOfDecade as v, startOfISOWeekYear as vi, getWeekOfMonth as vn, endOfYear as vr, isYesterday as vt, setMilliseconds as w, addHours as wi, getMinutes as wn, startOfQuarter as wr, isToday as wt, setSeconds as x, getISOWeekYear as xi, getSeconds as xn, eachWeekendOfInterval as xr, isWednesday as xt, setYear as y, differenceInCalendarDays as yi, getUnixTime as yn, eachWeekendOfMonth as yr, subDays as yt, previousTuesday as z, formatRFC3339 as zn, differenceInISOWeekYears as zr, isSameMinute as zt };
